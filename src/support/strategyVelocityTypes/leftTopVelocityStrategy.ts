...
/**
* LeftTopVelocityStrategy
* Strategy for left top velocity transition.
*
* @implements VelocityStrategy
*/
export default class LeftTopVelocityStrategy implements VelocityStrategyInterface {
  /**
  ...
  public transition = (
    ...
    if (startPositionCopy.x <= endPosition.x
