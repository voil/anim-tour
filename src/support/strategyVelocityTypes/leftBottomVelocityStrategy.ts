...
/**
* LeftBottomVelocityStrategy
* Strategy for left bottom velocity transition.
*
* @implements VelocityStrategy
*/
export default class LeftBottomVelocityStrategy implements VelocityStrategyInterface {
  /**
